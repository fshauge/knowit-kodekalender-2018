// Float equality checking using an epsilon
const checkEquality = (a, b) => Math.abs(a - b) < Number.EPSILON;
...
function run(input) {
  ...
  for (const line of lines) {
    ...
    const group = groups.find(group => checkEquality(group.slope, slope));
